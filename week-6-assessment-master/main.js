...
*/
function addKeyPowerIndex(arrOfObject){

  // WRITE YOUR CODE UNDER THIS LINE
  key=0;
 arrOfObject.forEach(function(object){
    object[key]=key*key;
    key++;
  });
return arrOfObject;
}
var arrOfObj1 = [{ a: 12 },{ b: 5 },{ c: 16 },{ d: 4 },{ e: 3 }];
...
function decreseBy(arr,num) {
  // WRITE YOUR CODE UNDER THIS LINE
  newArr=arr.map(function(nums){return nums-10});
  return newArr;

}
var arrOfNum1 = [83, 11, 39];
...
function nameLongerThan(arrOfObj,num) {
  // WRITE YOUR CODE UNDER THIS LINE
  var arr=arrOfObj.filter(function(object){
    return object.name.length>num;
...
function avgLength(arrOfObj,string) {
  // WRITE YOUR CODE UNDER THIS LINE
